namespace AccountService.Projections.Api.Tests.Infrastructure
{
    ...
    public static class StringBuilderExtensions
    {
        ...
        public static StringBuilder AppendTitleBlock(
            this StringBuilder builder,
            string title,
            string content) => builder.AppendTitleBlock(title, b => b.AppendLine(content));

        public static StringBuilder AppendTitleBlock<T>(
            this StringBuilder builder,
            string title,
            IEnumerable<T> collection,
            Func<T, string> formatter) => builder.AppendTitleBlock(title, b => b.AppendLines(collection, formatter));
