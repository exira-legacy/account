namespace AccountService.Tests.Infrastructure
{
    ...
    using AccountService.Infrastructure.Modules;
    using KellermanSoftware.CompareNetObjects;
    using Microsoft.Extensions.Configuration;
    using Newtonsoft.Json;
    using Xunit.Abstractions;

    public class AccountServiceTest : AutofacBasedTest
    {
        ...
        public AccountServiceTest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
